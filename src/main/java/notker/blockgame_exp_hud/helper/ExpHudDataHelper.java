...
public class ExpHudDataHelper {
    ...
    public static final String[] nbtKeyNames = {
            MMOItemModifiersHelper.ADD_EXP_ARCHAEOLOGY.tag(),
            MMOItemModifiersHelper.ADD_EXP_FISHING.tag(),
            MMOItemModifiersHelper.ADD_EXP_HERBALISM.tag(),
            MMOItemModifiersHelper.ADD_EXP_LOGGING.tag(),
            MMOItemModifiersHelper.ADD_EXP_MINING.tag(),
            MMOItemModifiersHelper.ADD_EXP_RUNECARVING.tag(),
            MMOItemModifiersHelper.ADD_EXP.tag()
    };
